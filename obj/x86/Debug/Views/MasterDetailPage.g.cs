#pragma checksum "C:\Users\13sch\source\repos\App5\App5\Views\MasterDetailPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "C1A0CE88054F12FFDC896473F9C66173"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace App5.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        {
            private global::App5.Models.SampleOrder dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::App5.Models.SampleOrder) item, 1 << phase);
            }
        ...
        private class MasterDetailPage_obj1_Bindings :
            ...
            IMasterDetailPage_Bindings
        {
            private global::App5.Views.MasterDetailPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::App5.Views.MasterDetailPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::App5.Views.MasterDetailPage obj, int phase)
            {
            ...
            private void Update_SampleItems(global::System.Collections.ObjectModel.ObservableCollection<global::App5.Models.SampleOrder> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void UpdateTwoWay_11_SelectedItem()
            {
                if (this.initialized)
                {
                    ...
                    {
                        this.dataRoot.Selected = (global::App5.Models.SampleOrder)this.obj11.SelectedItem;
                    }
                }
            }
            ...
            private class MasterDetailPage_obj1_BindingsTracking
            {
                ...
                public void PropertyChanged_(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        global::App5.Views.MasterDetailPage obj = sender as global::App5.Views.MasterDetailPage;
                ...
                public void UpdateChildListeners_(global::App5.Views.MasterDetailPage obj)
                {
                    MasterDetailPage_obj1_Bindings bindings = TryGetBindingObject();
                    if (bindings != null)
                    {
